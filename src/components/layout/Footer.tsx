  ...
  return (
    <footer className="border-t border-zinc-200 dark:border-zinc-800 mt-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              aria-label="Email"
              className="text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors text-xs font-mono"
            >
        ...
        <div className="mt-8 pt-6 border-t border-zinc-100 dark:border-zinc-800/50 flex items-center justify-center">
          <p className="text-xs text-zinc-400 dark:text-zinc-600 font-mono">
            © {new Date().getFullYear()} Sahil Patel · Melbourne, AU
          </p>
        </div>
      </div>
    </footer>
