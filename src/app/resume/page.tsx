...
const RESUME_URL =
  "https://drive.google.com/file/d/1uoKICygMApAIeCO2svlQj-EzQoUcc7kQ/view?usp=sharing";

// Convert Google Drive view URL to embed URL
const EMBED_URL =
  "https://drive.google.com/file/d/1uoKICygMApAIeCO2svlQj-EzQoUcc7kQ/preview";
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-10">
          ...
          >
            ...
            <a
              href={`https://drive.google.com/uc?export=download&id=1uoKICygMApAIeCO2svlQj-EzQoUcc7kQ`}
